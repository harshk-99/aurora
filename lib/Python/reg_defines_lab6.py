...
def IDS_HW_DATA_CTRL_REG ():  
    return 0x2000304

def IDS_HW_DATA_HIGH_REG ():  
    return 0x2000308

def IDS_HW_DATA_LOW_REG ():   
    return 0x200030c
...
__main__.nf_regmap.update({
    ...
    0x2000304 : "IDS_HW_DATA_CTRL_REG",
    0x2000308 : "IDS_HW_DATA_HIGH_REG",
    0x200030c : "IDS_HW_DATA_LOW_REG",
