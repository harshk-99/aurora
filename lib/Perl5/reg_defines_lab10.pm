...
sub IDS_SW_READADDR_W_REG ()   { 0x2000300;}
sub IDS_SW_CMD_REG ()          { 0x2000304;}
sub IDS_HW_DATA0_REG ()        { 0x2000308;}
sub IDS_HW_DATA1_REG ()        { 0x200030c;}
sub IDS_HW_DATA2_REG ()        { 0x2000310;}
sub IDS_HW_DATA3_REG ()        { 0x2000314;}
sub IDS_HW_DATA4_REG ()        { 0x2000318;}
sub IDS_HW_DATA5_REG ()        { 0x200031c;}
sub IDS_HW_DATA6_REG ()        { 0x2000320;}
sub IDS_HW_DATA7_REG ()        { 0x2000324;}
sub IDS_HW_DATA8_REG ()        { 0x2000328;}
sub IDS_HW_DATA9_REG ()        { 0x200032c;}
sub IDS_HW_DATA10_REG ()       { 0x2000330;}
sub IDS_HW_DATA11_REG ()       { 0x2000334;}
